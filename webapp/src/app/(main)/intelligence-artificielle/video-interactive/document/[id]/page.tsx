...
import { RenderGroupedVideoTranscriptCard, RenderVideoTranscriptCard, RenderVideoTranscriptDocumentCard, YoutubeEmbed } from '@/app/(main)/recherche/DocumentChunkFull';
import Button from '@codegouvfr/react-dsfr/Button';
import { groupVideo } from '@/app/(main)/recherche/RenderSearch';
