...
export const h5pIdToPublicUrl = (h5pContentId: string, s3ObjectName: string) => `${H5P_PUBLIC_URL}/h5p/s3/${s3ObjectName}/${h5pContentId}?readOnlyState=yes&asUserId=${Math.random()}`