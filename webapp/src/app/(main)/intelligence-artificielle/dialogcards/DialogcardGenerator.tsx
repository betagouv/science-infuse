...
export default () => {
    ...
    return (
        <div className="flex flex-col w-full gap-4 items-center">
            ...
            {!documentId && !loading && <>
                <h1 className="m-0 h1 text-center">Je crée des dialogcards</h1>
                <div className="flex flex-col md:flex-row gap-6 w-full">
                    ...
                    <div className="flex flex-col justify-center max-w-2xl flex-1">
                        <p className="text-base text-start text-[#161616] mb-4 sm:mb-6">
                            Créez facilement des dialogcards pour renforcer l'apprentissage en recherchant ou en important un document.
                        </p>
                        <StyledSegControl
                            small
