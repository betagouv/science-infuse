    ...
    return (
        <div className="mx-auto w-full flex flex-col items-center gap-8 px-4">
            ...
            <p className="text-lg md:text-xl text-center text-[#161616] mb-8">
                Trouvez les contenus pour illustrer ou animer votre prochain cours, parmi les milliers de ressources gratuites 
                de la Cité des sciences et de l'industrie, du Palais de la découverte et de leurs partenaires.
            </p>
