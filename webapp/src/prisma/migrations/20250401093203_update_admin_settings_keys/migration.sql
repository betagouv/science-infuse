...
-- AlterEnum
BEGIN;
CREATE TYPE "AdminSettingKey_new" AS ENUM ('H5P_URL', 'FEATURE_DIALOGCARDS_BETA_ONLY', 'FEATURE_TEXTE_A_TROUS_BETA_ONLY', 'FEATURE_MOTS_CROISES_BETA_ONLY', 'FEATURE_QUIZZ_BETA_ONLY', 'FEATURE_VIDEO_INTERACTIVE_BETA_ONLY', 'FEATURE_IMAGE_A_COMPLETER_BETA_ONLY', 'FEATURE_CHATBOT_BETA_ONLY');
