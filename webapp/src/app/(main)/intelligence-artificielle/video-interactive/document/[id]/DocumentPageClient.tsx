...
import { RenderVideoTranscriptDocumentCard } from '@/app/(main)/recherche/DocumentChunkFull';
...
export default function DocumentPageClient({ documentId }: DocumentPageClientProps) {
