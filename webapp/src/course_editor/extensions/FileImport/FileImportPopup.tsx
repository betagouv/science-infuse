...
const FileImport = (props: { pos: number, editor: Editor; closePopup: () => void }) => {
  ...
  return (
    <div className="flex h-full transition-[0.4s] w-full items-center justify-center bg-[#16161686]">
      ...
      <div ref={ref} tabIndex={0} className="relative flex flex-col items-center gap-8 bg-[#f6f6f6] rounded-lg shadow-lg p-16 w-[80vw] max-w-[1200px] max-h-[90vh]">
        <div className='absolute top-4 right-4'>
          <IconButton onClick={handleClosePopup} aria-label="Fermer la fenêtre d'importation de fichier">
            <CloseIcon />
          </IconButton>
        </div>
