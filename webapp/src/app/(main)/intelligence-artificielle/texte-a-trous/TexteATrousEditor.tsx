...
export const generateTexteATrousData = async (params: { documentId?: string; chunkId?: string }): Promise<[Error | null, TexteATrousSet | null]> => {
    try {
        const response = await apiClient.generateTexteATrous(params);
    ...
    const handleSaveChanges = useCallback(async () => {
        ...
        if (isDocumentMode && documentId) {
            ...
            try {
                ...
                alertToast.success("Succès", "Texte à trous mis à jour avec succès");
            } finally {
                setIsSaving(false);
            }
        }
    }, [questions, isDocumentMode, documentId, updateTexteATrous, alertToast, h5pContentId, onH5PGenerated]);
